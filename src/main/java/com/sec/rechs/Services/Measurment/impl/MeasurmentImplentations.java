package com.sec.rechs.Services.Measurment.impl;
 ...
 */
@Service
public class MeasurmentImplentations {

    private static final Logger LOG = LoggerFactory.getLogger(MeasurmentImplentations.class);
